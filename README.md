...
You need [Llama-3.1-8B-Instruct](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct) model permission or you can modify the [script](/source/module/generate/llama.py) a bit for your own LLM.
