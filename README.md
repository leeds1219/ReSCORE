...
You need [Llama-3.1-8B-Instruct]([https://huggingface.co/TheBloke/Llama-3.1-8B-Instruct](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct)) model permission or you can modify the code a bit for your own LLM.
